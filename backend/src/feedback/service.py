...
**오버스트라이드 개선 방법 제시**
0.18 초과시, 발이 몸 앞에 과도하게 착지해 제동(braking)이 커지고, 무릎·하체 부하 및 부상 위험 증가.
...
**수직 반동 개선 방법 제시**
0.10 미만: [미달 - 경직형] 탄성 활용 부족, 보폭 제한 가능성 높음.
0.10 ~ 0.41: [정답 - 프로 표준] 효율적이고 안정적인 수직 밸런스.
0.41 초과: [초과 - 낭비형] 수직 에너지 손실 과다, 착지 충격 큼.
